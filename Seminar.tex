...
\\
\\
 $(1 + f_{n}(z)) \in \C \setminus \R_{\leq 0 }$ gilt. Zeige weiter $F_{N}(z) := \sum_{n = N}^\infty \Log( 1 + f_{n}(z))$ ist normal konvergent auf U. Dies folgt daraus, dass $| Log( 1 + z) | \leq 2|z| $ für $z \in \C mit |z| \leq \frac{1}{2}$ nach Hilfslemma (1) und der Tatsache das mit der Abschätzung von $|Log(1+z)| \leq 2|z|$ mit $|f_n(z)|\leq \frac{1}{2}$ genau der Definition der Normalen Konvergenz entspricht.
